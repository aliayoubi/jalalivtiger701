...
$languageStrings = array (
  ...
  'Actual Response Count' => 'مقدار دريافتي واقعي',
  'Actual ROI' => 'نرخ بازگشت سرمايه ي واقعي',
  'Actual Sales Count' => 'تعداد فروش واقعي',
  'Advertisement' => 'آگهي تبليغاتي',
  'Average' => 'متوسط',
  'Banner Ads' => 'تبليغات بنر',
  'Budget Cost' => 'هزينه در نظر گرفته شده',
  'Campaign Name' => 'نام کمپین تبلیغاتی',
  'Campaign No' => 'شماره کمپین تبلیغاتی',
  'Campaigns' => 'کمپین های تبلیغاتی',
  'Campaign Status' => 'وضعيت کمپین تبلیغاتی',
  ...
  'Excellent' => 'عالي',
  'Expected Response Count' => 'مقدار دريافتي مورد انتظار',
  'Expected Response' => 'پاسخ مورد انتظار',
  'Expected Revenue' => 'درآمد مورد انتظار',
  'Expected ROI' => 'نرخ بازگشت سرمايه ي مورد انتظار',
  ...
  'LBL_EXPECTATIONS_AND_ACTUALS' => 'انتظارات و واقعيت ها',
  'LBL_RECORDS_LIST' => 'لیست کمپین های تبلیغاتی',
  '--None--' => '--هيچ--',
  'Num Sent' => 'تعداد ارسالي',
  'Others' => 'ساير',
  'Planning' => 'در حال برنامه ريزي',
  'Poor' => 'ضعيف',
  'Product' => 'محصول',
  'Referral Program' => 'کمپين تبليغاتي',
  'SINGLE_Campaigns' => 'کمپین تبلیغاتی',
  'Sponsor' => 'پشتيبان',
  'Target Audience' => 'جامعه هدف تبليغات',
  'TargetSize' => 'وسعت بازار هدف',
  'Telemarketing' => 'بازاريابي تلفني',
