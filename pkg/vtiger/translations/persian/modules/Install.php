...
$languageStrings = array (
  ...
  'ERR_UNABLE_CREATE_DATABASE' => 'عدم امکان در ایجاد بانک اطلاعاتی',
  ...
  'LBL_RETYPE_PASSWORD' => 'کلمه عبور را مجدد وارد کنید',
  'LBL_ROOT_PASSWORD' => 'کلمه عبور Root',
  ...
  'LBL_VTIGER7_SETUP_WIZARD_DESCRIPTION' => 'این مراحل شما را در نصب ویتایگر ورژن 7 یاری میدهد',
  'LBL_WELCOME_TO_VTIGER7_SETUP_WIZARD' => 'به صفحه تنظیمات ویتایگر ورژن 7 خوش آمدید',
  ...
  'MSG_DB_ROOT_USER_NOT_AUTHORIZED' => 'پیام: نام کابری ریشه که برای بانک اطلاعاتی وارد کردید مجوز لازم برای تولید بانک را ندارد و یا از کاراکتر خاص در نام بانک استفاده کرده اید',
