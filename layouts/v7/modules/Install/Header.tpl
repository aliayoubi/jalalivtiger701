...
{strip}
	...
	<html>
		...
		@font-face {	
			font-family: 'hami';
		  src: url('./layouts/v7/modules/Install/resources/css/hami.eot');
		  src: url('./layouts/v7/modules/Install/resources/css/hami.eot?#iefix') format('embedded-opentype'),
			   url('./layouts/v7/modules/Install/resources/css/hami.woff') format('woff'), 
			   url('./layouts/v7/modules/Install/resources/css/hami.ttf')  format('truetype'), 
			   url('./layouts/v7/modules/Install/resources/css/hami.svg#svgFontName') format('svg');
		}
