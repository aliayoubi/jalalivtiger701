	...
	<html lang="en">
		<head>
			...
			<style type="text/css">
				...
				@font-face {
						  font-family: 'hami';
						  src: url('layouts/v7/modules/Users/fonts/hami.eot');
						  src: url('layouts/v7/modules/Users/fonts/hami.eot?#iefix') format('embedded-opentype'),
							   url('layouts/v7/modules/Users/fonts/hami.woff') format('woff'), 
							   url('layouts/v7/modules/Users/fonts/hami.ttf')  format('truetype'), 
							   url('layouts/v7/modules/Users/fonts/hami.svg#svgFontName') format('svg');
						}
					body{
						font-family: hami, Tahoma;
						background: #F4FAFC;
						color : #555;
						font-size: 13px;
						min-height: 98%;
			...
			<div class="container-fluid page-container">
				...
				<div class="row-fluid main-container">
					<div class="span12 inner-container">
						<div class="row-fluid">
							<div class="span8">
								<p style="display: inline-block;float:left;margin-top:4px;">&nbsp;&nbsp;(ویژگی های مورد نظر را انتخاب کنید)</p>
								<h3 style="display: inline-block;float:left;"> چه استفاده ای می خواهید از ویتایگر بکنید؟ </h3> 
								
							</div>
							<div class="span4">
								<div class="pull-right"><label for="checkbox-1" style="vertical-align:bottom;margin:0;margin-top:8px\9;margin-left:10px\9;font-size:15px;"><strong> انتخاب همه</strong></label> <input type="checkbox" name="selectAll" class="selectAll"/><div class="chkbox"></div></div>
							</div>
						</div>
						<hr>
						<form id="SystemSetup" class="form" method="POST" action="index.php?module=Users&action=SystemSetupSave">
							...
							{foreach from=$PACKAGES_LIST key=PACKAGE_NAME item=PACKAGE_INFO}
								{if $COUNTER eq 0 || $COUNTER mod 2 eq 1}
									...
									<div class="group-container {if $COUNTER eq 0} span12 selectedContainer js-basePack {else} span6 {/if}">
										<div class="module_list"><a>  ماژول ها </a></div>
										<div class="row-fluid">
										...
										{if $COUNTER eq 0}		
											<div class="row-fluid">
												<div class="offset2 span10">
													...
													<strong> این ویژگی به صورت پیش فرض نصب خواهد شد. </strong></label>
												</div>
											</div>
										{/if}
										<div class="reveal_modules">
											<div>
												...
												<strong>این ماژول ها برای این ویژگی فعال خواهند شد.</strong><hr>
												<div>	
							...
							<div class="row-fluid">
								<div class="span9">
									<strong>توجه: </strong> شما بعداً نیز می توانید از بخش مدیریت ماژول، آن ها را فعال یا غیر فعال کنید.  
								</div>
								<div class="span3">
									<div class="button-container">
										<button type="submit" class="btn btn-large btn-primary next" value="Next" style="font-family: hami!important;" >بعدی </button>
									</div>
								</div>
							</div>
						</form>
