			...
			<div class="loginDiv widgetHeight">
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group">
							<input id="username" type="text" name="username" placeholder="نام کاربری" value="admin">
							<span class="bar"></span>
							<label>نام کاربری"</label>
						</div>
						<div class="group">
							<input id="password" type="password" name="password" placeholder="رمزعبور" value="admin">
							<span class="bar"></span>
							<label>رمزعبور"</label>
						</div>
						<div class="group">
							<button type="submit" class="button buttonBlue">ورود</button><br>
							<a class="forgotPasswordLink" style="color: #15c;">رمزعبور خود را فراموش کرده اید؟</a>
						</div>
					</form>
				</div>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						...
						<div class="group">
							<input id="email" type="email" name="emailId" placeholder="پست الکترونیکی" >
							<span class="bar"></span>
							<label>پست الکترونیکی" </label>
						</div>
						<div class="group">
							<button type="submit" class="button buttonBlue forgot-submit-btn">ارسال</button><br>
							<span>لطفا جزئیات را وارد کرده و ارسال نمایید.<a class="forgotPasswordLink pull-right" style="color: #15c;">بازگشت</a></span>
						</div>
					</form>
				</div>
			</div>
