	...
	public static function getPackagesList() {
		...
		$packagesList = array(
			'Tools' => array(
				...
				'description' => 'مخاطبان شما را در کنار جزئیات  و یادداشت های مرتبط با آنها، اسناد، ایمیل ها، رویدادهای تقویم و ... یکپارچه و نگهداری می کند.علاوه بر این تنظیم می کند که چه اطلاعاتی را هر کاربر سی آر ام شما بتواند ببیند یا به روز رسانی کند و همچنین فعالیت های کاری را مثل پاسخ به ایمیل و به روز رسانی اطلاعات اتوماتیک می کند.',
				'modules' => array(
					'Contacts' => 'مخاطبان',
					'Accounts' => 'سازمان ها',
					...
					'Mail Converter' => 'مبدل ایمیل',
					'Calendar' => 'تقویم',
					'Web-to-lead forms' => 'فرم ها',
					'RecycleBin' => 'سطل بازیافت',
					'Web-to-lead forms' => 'فرم ها',
					'EmailTemplates' => 'قالب های ایمیل',
					'Documents' => 'اسناد',
					'SMSNotifier' => 'هشدار پیامکی',
				)),
			'Sales' => array(
				'label' => 'اتوماسیون فروش',
				'imageName' => 'SalesAutomation.png',
				'description' => 'سرنخ ها از طریق وب سایت شما یا از طریق ایمپورت فایل، جمع آوری می شوند سپس یک جریانی برای معتبر سازی داخل فرصتهای فروش صورت می پذیرد تا فرصت های فروش تبدیل به برد شوند.',
				'modules' => array(
					'Potentials' => 'فرصت ها',
					'Leads' => 'سرنخ های فروش',
				)),
			'Marketing' => array(
				...
				'description' => 'ارسال تکی یا گروهی و هدفمند ایمیل به مخاطبان، سرنخ ها و مشتریان و همچنین دیدن اینکه چطور آنها ارتباط بر قرار میکنند با هر تماس، با استفاده از ابزارهایی که امکان آنالیز و  بهبود کارایی کمپین های تبلیغاتی را می دهند.',
				'modules' => array(
			...
			'Support' => array(
				...
				'description' => 'درخواست های مشتریان را از طریق تیکت ها ایجاد و دنبال می کند و همچنین به مشتریان شما این اجازه را می دهد که تیکت های خود را از طریق پورتال مشتری ایجاد و دنبال کنند.',
				'modules' => array(
					'HelpDesk' => 'تیکت ها',
					'ServiceContracts' => 'قرارداد خدمات',
					'CustomerPortal' => 'پرتال مشتری',
					'Faq' => 'پرسش های متداول',
				)),
			'Inventory' => array(
				'label' => 'مدیریت موجودی و صورتحساب',
				'imageName' => 'Inventory.png',
				'description' => 'یک بانک اطلاعاتی از محصولات و خدمات شما، نگهداری موجودی، قیمت های استاندارد و دفترچه قیمت ایجاد می کند و این ها برای ایجاد پیش فاکتورها، فاکتورها، سفارشات فروش استفاده می شوند.',
				'modules' => array(
					'Quotes' => 'پیش فاکتور',
					'Invoice' => 'فاکتور',
					'SalesOrder' => 'سفارش فروش',
					'PurchaseOrder' => 'سفارش هرید',
					'PriceBooks' => 'کتابچه قیمت',
					'Products' => 'محصولات',
			...
			'Project' => array(
				...
				'description' => 'ایجاد و مدیریت پروژه های مشتری سازی، با استفاده از جزئیات وظایفی که می تواند به کاربران سی آر ام واگذار شود و در تقویم آن ها قرار گیرد.',
				'modules' => array(
					'Project' => 'پروژه ها',
					'ProjectTask' => 'وظایف',
					'ProjectMilestone' => 'فازهای کاری',
				))
		);
